              ...
              {step === 5 && (
                <div className="space-y-4">
                  <div className="bg-purple-50 rounded-xl p-3 border border-purple-100">
                    <p className="text-purple-700 text-sm">{t('skillH')}</p>
                  </div>
                    ...
                    {templateList.map(x => (
                      <div key={x.id} className={`flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all ${template === x.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'}`} onClick={() => setTemplate(x.id)}>
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className={`font-semibold text-sm ${template === x.id ? 'text-blue-700' : 'text-gray-800'}`}>{t(x.id)}</h3>
                  ...
                  {saved ? (
                    ...
                    <>
                      ...
                      <div className="space-y-3 pt-3 border-t border-gray-100">
                        ...
                        <div className="flex gap-3">
                          <button onClick={() => setShowSignup(true)} className="flex-1 py-2.5 bg-indigo-600 text-white rounded-xl font-medium hover:bg-indigo-700">{t('saveYes')}</button>
                          <button className="flex-1 py-2.5 border border-gray-200 text-gray-600 rounded-xl font-medium hover:bg-gray-50">{t('saveNo')}</button>
                        </div>
                      </div>
          ...
          {step < 8 && (
            <div className="flex-1 hidden lg:block">
              <div className="sticky top-24">
                ...
                <div ref={cvRef} className="bg-white rounded-xl shadow-xl overflow-hidden border" style={{ aspectRatio: '210/297' }}>
