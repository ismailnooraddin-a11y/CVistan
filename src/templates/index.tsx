    ...
    <div className={`bg-white min-h-full ${rtl?'text-right':''}`}>
      ...
      <div className="p-8 grid grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          {d.personal.location&&<section className="bg-gray-50 rounded-xl p-4"><h2 className="text-sm font-bold text-blue-600 uppercase mb-2">Contact</h2><p className="text-gray-600 text-sm">📍 {d.personal.location}</p>{d.personal.linkedin&&<p className="text-gray-600 text-sm">🔗 {d.personal.linkedin}</p>}</section>}
